    ...
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <div className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
            {workData.map((project, index)=>(
                <div key={index} className='aspect-square bg-no-repeat 
                bg-cover bg-center rounded-lg relative cursor-pointer group' style={{backgroundImage : `url(${project.bgImage})`}}>
                    ...
                    aspect-square flex items-center jsutify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 transition'>
        ...
        y-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>
